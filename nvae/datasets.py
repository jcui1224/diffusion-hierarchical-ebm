...
import os
import urllib
from nvae.lmdb_datasets import LMDBDataset
from nvae.thirdparty.lsun import LSUN
...
def get_loaders_eval(dataset, args):
    ...
    if dataset == 'cifar10':
        ...
        if dataset == 'celeba_64':
            ...
            train_data = dset.CelebA(root=args.data, split='train', download=False, transform=train_transform)
            valid_data = dset.CelebA(root=args.data, split='valid', download=False, transform=train_transform)
